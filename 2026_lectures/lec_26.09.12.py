...
# dictionary
'''
1) A Python dictionary stores information as 
key–value pairs.
2) define a empty dictionary with curly braces {} 
   and key: value pairs.
    teacher = {}
3) keys must be unique; the values do not have to be unique
'''
# Dictionary teacher and add items later:
teacher = {}
teacher["name"] = "Su"
print("The teacher's name is ", teacher["name"])
print("--------------")
# Dictionary student
student = {
    "name": "Alice",
...
# enumerate() in Python is used when you 
#want to loop over a sequence and also get 
# the index
...
def twoSum(nums, target):
    ...
    for index, value in enumerate(nums):
           ...
           # Check if firstNumber exists in dic
           if firstNumber in dic:
               return [dic[firstNumber],index]
           dic[value] = index
